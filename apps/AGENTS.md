# Scoped agent instructions — `apps/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `apps/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Routes, UI components, handlers, data access, authentication flows, or other production application logic.
