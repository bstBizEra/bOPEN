# Scoped agent instructions — `infrastructure/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `infrastructure/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Runtime configuration, deployment manifests, migrations, credentials, secrets, or environment-specific state.
