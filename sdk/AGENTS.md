# Scoped agent instructions — `sdk/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `sdk/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Client implementations, generated code, authentication helpers, network calls, or published SDK artifacts.
