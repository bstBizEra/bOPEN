# Scoped agent instructions — `contracts/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `contracts/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Stable contracts, normative approval claims, generated clients, migrations, or executable validation logic.
