...
| [BOPEN-WP-GOV-AUTONOMY-001](BOPEN-WP-GOV-AUTONOMY-001.md) | Governed-Autonomy Bootstrap (SecB L0 port) | **RATIFIED** — Genesis Ratification by operator merge `aa3d126b` (PR #3, 2026-08-10); a constitutional ratification per [`DEC-GOV-AUTONOMY-001`](../decisions/DEC-GOV-AUTONOMY-001.md), not an EBIV verification claim | `AGENTS.md` §31 in force: GL root constitution, delegation envelope `AT1`, four enforcement gates, `governance-gates` CI, non-rewrite canonical cutover to `main`. |
