# BOOT-P0-11 — First vertical-slice specification
...
Specify principal -> tenant -> owner membership -> context -> authorization -> audit.
...
`docs/evidence/EVD-BOOT-006-first-vertical-slice-fixtures.md` and `docs/evidence/EVD-BOOT-009-bootstrap-self-review.md`.
