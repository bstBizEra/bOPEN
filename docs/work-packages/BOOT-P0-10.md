# BOOT-P0-10 — Normative architecture queue
...
Initiate REQ/ARCH/TENANT/AUTHZ/ENT/MOD/PARTY/SEC drafts.
...
`docs/evidence/EVD-BOOT-005-contract-validation-harness.md` and `docs/evidence/EVD-BOOT-009-bootstrap-self-review.md`.
