...
- full repository validation passes and an independent checker reviews the exact final SHA.

## Required checks/evidence

Focused QUAL-P0-00 tests; full Python test discovery; contract and repository validators; program and authority reports; package-manifest check; clean-room, secret and supply-chain checks; `git diff --check`; exact-SHA independent review.
