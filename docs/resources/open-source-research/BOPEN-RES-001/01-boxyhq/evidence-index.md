...
| Evidence ID | Class | Source | Observation | Status |
|---|---|---|---|---|
| BOX-E-013 | E2 | R1 trace contract and two external receipts | 26 path/marker observations independently match the pinned source. | Confirmed |
| BOX-E-014 | E2 | Playwright `--list` receipts | 42 test declarations are discoverable in 9 files; no tests were executed. | Confirmed |
