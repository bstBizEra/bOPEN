...
The R1 validator independently verified 57 case-specific evidence records in two detached checkouts at the pinned commit: 47 observations and 10 gap anchors. The controlled matrix records required layers per lifecycle case and preserves missing behavior as explicit gaps:
