# Scoped agent instructions — `docs/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `docs/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Approval claims, signed-byte edits, changes to governance registers, or mutation of root-ledger genesis.
