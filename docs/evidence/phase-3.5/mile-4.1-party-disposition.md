...
**Version:** `1.0.0`
**Status:** **AWAITING_OPERATOR_DISPOSITION** — the Codex ballot is **confirmed from repository objects** (7… see §1: 13/13 `CONFIRMED`, no refutations). The §4 disposition is reserved to the operator.
**Issued:** 2026-08-03
