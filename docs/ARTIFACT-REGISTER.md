...
| BOPEN-IDP-001 | Enterprise Identity, Federation, Provisioning & Session Claims Standard | Normative | **Approved; Phase 2 technical evidence corrected, acceptance pending** | Engineering Authority |
| BOPEN-MOD-001 | Product, Module, Feature & Capability Contracts Specification | Normative | **Approved for Phase 3 planning and contract freeze; implementation held** | Architecture Authority |
| BOPEN-ENT-001 | Entitlement, Usage & Commercial Kernel Specification | Normative | **Approved for Phase 3 planning and contract freeze; implementation held** | Product/Architecture Authorities |
| BOPEN-P3-001 | Phase 3 Capability & Commercial Entitlement Kernel Execution Plan | Work package | **Draft; implementation hold until contract freeze and entry gate** | Platform Kernel Engineering Authority |
| BOPEN-PROD-MATRIX-001 | bOPEN Capability & Architecture Matrix | Normative | **Approved** | Product Authority |
| BOPEN-PROD-PLAN-001 | bOPEN Future Development Plan | Normative | **Approved** | Product/Engineering Authorities |
| BOPEN-ARCH-TECH-001 | bOPEN Technology Matrix & Scoring Specification | Normative | **Approved** | Architecture Authority |
| BOPEN-ENG-LANG-001 | bOPEN Programming Language Stacks Matrix & Scoring Spec | Normative | **Approved** | Engineering Authority |
| BOPEN-ARCH-PLAN-001 | bOPEN Final Integrated Technology & Language Architecture Plan | Normative | **Approved** | Architecture Authority |
