# Scoped agent instructions — `tests/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `tests/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Production business behavior, optimistic placeholders, external side effects, or tests that weaken tenant and authorization controls.
