# Scoped agent instructions — `packages/`

**Status:** Draft preparation control  
**Work package:** `SKEL-P0-01`  
**Stable dependency:** No

These instructions apply to every path below `packages/`. They supplement repository-level governance and **never weaken** a stricter instruction or signed control.
...
Zone-specific prohibition: Runtime exports, domain algorithms, persistence models, stable APIs, or dependency publication.
